    ...
    return(
        ...
        <div className="ml-4 md:p-10">
            ...
            <div className="flex flex-col gap-4">
                <h1 className="text-2xl md:text-[50px] text-slate-700 font-serif">Pedro Henrique Martins</h1>
                <h2 className="text-xl md:text-[30px] text-slate-700 font-serif">Engenheiro de Software</h2>
            </div>

            <div className="flex flex-col w-24 text-[12px] md:text-[18px] font-bold text-black mt-8 gap-4">
